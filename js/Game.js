class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage("blastI", blastImage);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("blastI", blastImage);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        var inf = allPlayers[plr].life;
        if (inf <= 0){
          cars[index - 1].changeImage("blastI", blastImage);
          this.explosion = true;
        }
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 340, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 340, 185, 20);
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 340, player.life, 20);
    noStroke();
    pop();
  }
